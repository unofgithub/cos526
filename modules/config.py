...
def config_parser():
    ...
    parser.add_argument("--use_msssim", type=str, default="False", help='whether or not to use ms-ssim loss term')
    parser.add_argument("--use_dists", type=str, default="False", help='whether or not to use DISTS loss term')
    ...
    parser.add_argument("--canny_low", type=float, default=0.1, help='canny low')
    parser.add_argument("--canny_high", type=float, default=0.2, help='canny high')

    parser.add_argument("--adaptive_splattingr", type=str, default="False", help='auto-selection of splatting r')
    parser.add_argument("--adaptive_datar", type=str, default="False", help='auto-selection of data r')
    parser.add_argument("--remove_outlier", type=str, default="True", help='whether or not to remove outlier points in pointcloud')

    parser.add_argument("--splatting_r", type=float, default=0.015, help='the radius for the splatting')
    parser.add_argument("--raster_n", type=int, default=15, help='the number of points per pixel for soft rasterization')
    parser.add_argument("--refine_n", type=int, default=2, help='the point number for soft rasterization')
    parser.add_argument("--data_r", type=float, default=0.012, help='the point number for soft rasterization')
    ...
    #parser.add_argument("--img_s", type=int, default=400, help='image size')
    parser.add_argument("--img_h", type=int, default=400, help='image height')
    parser.add_argument("--img_w", type=int, default=400, help='image width')

...
def calc_splatting_r(edges):
    # https://stackoverflow.com/questions/30668683/how-can-i-calculate-the-overall-amount-of-detail-in-an-image
    splatting_r = torch.mean(edges) * 0.2
    # print("Detail Amount: ", torch.mean(edges))
    return splatting_r

def calc_data_r(splatting_r):
    data_r = splatting_r / 0.03
    return data_r